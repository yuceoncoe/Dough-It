        ...
        {Array.from({ length: totalDays }, (_, index) => {
          ...
          return (
            <button
              ...
              className={`flex min-h-[54px] flex-col justify-between rounded-md p-1.5 shadow-sm text-left transition-colors md:min-h-[76px] md:p-2 overflow-hidden ${isToday ? 'bg-amber-50 ring-2 ring-amber-400' : 'bg-white'}`}
            >
